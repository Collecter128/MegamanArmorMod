...
@OnlyIn(Dist.CLIENT)
public class helmet_mettaurnew extends BipedModel {
	...
	public helmet_mettaurnew(float modelSize) {
		super(modelSize);
		texWidth = 36;
		texHeight = 42;
		...
		Head.texOffs(0, 0).addBox(-4.5F, -10.9945F, -4.1045F, 9.0F, 5.0F, 9.0F, 0.5F, false);
		Head.texOffs(0, 14).addBox(-4.5128F, -10.8959F, -3.9907F, 9.0F, 6.0F, 9.0F, 0.75F, false);

		Head2 = new ModelRenderer(this);
		Head2.setPos(0.0F, 0.0F, 0.0F);
		setRotationAngle(Head2, -0.1047F, 0.0873F, 0.0F);
		Head2.texOffs(0, 28).addBox(-4.5F, -10.9945F, -4.1045F, 9.0F, 5.0F, 9.0F, 0.5F, false);
	}
