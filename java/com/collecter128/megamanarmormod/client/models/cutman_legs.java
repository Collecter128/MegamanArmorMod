...
public class cutman_legs extends BipedModel {
	...
	public cutman_legs(float modelSize) {
		super(modelSize);
		texWidth = 75;
		texHeight = 159;
		...
		Bodyorange.texOffs(16, 118).addBox(-4.0F, 8.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.61F, false);

		Bodygray = new ModelRenderer(this);
		Bodygray.setPos(0.0F, 0.0F, 0.0F);
		Bodygray.texOffs(16, 126).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		Bodygray.texOffs(16, 133).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		...
		RightLegwhite.texOffs(0, 108).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		RightLegglow.texOffs(16, 147).addBox(0.0F, 9.0F, -2.0F, 2.0F, 3.0F, 2.0F, 0.5F, false);

		LeftLegwhite = new ModelRenderer(this);
		LeftLegwhite.setPos(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLegwhite, -0.1745F, 0.0F, -0.0349F);
		LeftLegwhite.texOffs(40, 108).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
		...
		LeftLegglow.texOffs(27, 147).addBox(0.0F, 8.0F, -2.0F, 2.0F, 4.0F, 2.0F, 0.5F, true);
	}
