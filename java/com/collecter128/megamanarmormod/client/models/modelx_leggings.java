...
public class modelx_leggings extends BipedModel {
	...
	public modelx_leggings(float modelSize) {
		...
		Bodyredglow.texOffs(63, 113).addBox(1.5F, 9.5F, -3.1F, 2.0F, 2.0F, 1.0F, -0.2F, false);
		Bodyredglow.texOffs(28, 112).addBox(-3.5F, 9.5F, -3.1F, 2.0F, 2.0F, 1.0F, -0.2F, false);
		...
		RightLegredglow.texOffs(17, 151).addBox(-1.0F, 7.0F, -1.0F, 2.0F, 5.0F, 2.0F, 0.5F, false);
		...
		LeftLegredglow.texOffs(26, 151).addBox(-1.0F, 6.0F, -1.0F, 2.0F, 6.0F, 2.0F, 0.5F, true);
	}
