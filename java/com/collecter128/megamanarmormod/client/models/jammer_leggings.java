...
@OnlyIn(Dist.CLIENT)
public class jammer_leggings extends BipedModel {
	...
	public jammer_leggings(float modelSize) {
		super(modelSize);
		texWidth = 74;
		texHeight = 150;
		...
		Bodyblack.texOffs(16, 88).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
