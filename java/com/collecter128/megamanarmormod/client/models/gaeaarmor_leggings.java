...
@OnlyIn(Dist.CLIENT)
public class gaeaarmor_leggings extends BipedModel {
	...
	public gaeaarmor_leggings(float modelSize) {
		super(modelSize);
		texWidth = 99;
		texHeight = 212;
		...
		Bodyblue.texOffs(16, 116).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);

		Bodywhite = new ModelRenderer(this);
		Bodywhite.setPos(0.0F, 0.0F, 0.0F);
		Bodywhite.texOffs(72, 121).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);

		Bodyyellow = new ModelRenderer(this);
		Bodyyellow.setPos(0.0F, 0.0F, 0.0F);
		Bodyyellow.texOffs(43, 103).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);

		Bodyglowgreen = new ModelRenderer(this);
		Bodyglowgreen.setPos(0.0F, 0.0F, 0.0F);
		Bodyglowgreen.texOffs(79, 70).addBox(-1.5F, 8.3F, -3.0F, 3.0F, 3.0F, 1.0F, 0.3F, false);

		Bodygray = new ModelRenderer(this);
		Bodygray.setPos(0.0F, 0.0F, 0.0F);
		Bodygray.texOffs(16, 123).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		Bodygray.texOffs(72, 131).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);
		...
		RightLegredglow.texOffs(17, 137).addBox(-0.9994F, 7.2251F, -1.025F, 2.0F, 5.0F, 2.0F, 0.5F, false);
		...
		LeftLegredglow.texOffs(27, 137).addBox(-0.9994F, 6.792F, -1.0212F, 2.0F, 5.0F, 2.0F, 0.5F, true);
	}
