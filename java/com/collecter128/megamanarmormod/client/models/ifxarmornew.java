...
@OnlyIn(Dist.CLIENT)
public class ifxarmornew extends BipedModel {
	...
	private final ModelRenderer zeroRightArmgray;
	...
	public ifxarmornew(float modelSize) {
		...
		ZeroSecondColorDefault = 2171169;//Secondary Black
		ZeroThirdColorDefault = 16763151; // Hair/yellowgold
		...
		zeroRightArmgray = new ModelRenderer(this);
		zeroRightArmgray.setPos(-5.0F, 2.0F, 0.0F);
		setRotationAngle(zeroRightArmgray, -0.1745F, 0.0F, 0.0F);
		zeroRightArmgray.texOffs(27, 58).addBox(-3.0F, 5.6391F, -2.0F, 4.0F, 2.0F, 4.0F, 0.76F, false);

//		zeroRightArm4 = new ModelRenderer(this);
//		zeroRightArm4.setPos(-5.0F, 2.0F, 0.0F);
//		setRotationAngle(zeroRightArm4, -0.1745F, 0.0F, 0.0F);
//		zeroRightArm4.texOffs(40, 64).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
...
//	}
	...
	public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
		...
		fred = (float)( this.ZeroSecondColor >> 16 & 255) / 255.0F;
        fgreen = (float)(this.ZeroSecondColor >> 8 & 255) / 255.0F;
        fblue = (float)(this.ZeroSecondColor & 255) / 255.0F;
		...
		this.zeroRightArmgray.copyFrom(this.rightArm);
		zeroRightArmgray.render(matrixStack, buffer, packedLight, packedOverlay, fred, fgreen, fblue, alpha);
		
		//zeroRightArm4.render(matrixStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
	}
