...
@OnlyIn(Dist.CLIENT)
public class stormeagle_leggings extends BipedModel {
	...
	public stormeagle_leggings(float modelSize) {
		super(modelSize);
		texWidth = 73;
		texHeight = 271;
		...
		RightLeggreenglow.setPos(-2.9F, 12.0F, 1.0F);
		setRotationAngle(RightLeggreenglow, 0.192F, 0.0F, 0.0349F);
		RightLeggreenglow.texOffs(17, 100).addBox(0.0F, 9.0F, -2.0F, 2.0F, 3.0F, 2.0F, 0.5F, false);
		...
		LeftLeggreenglow.setPos(0.9F, 12.0F, 1.0F);
		setRotationAngle(LeftLeggreenglow, -0.1745F, 0.0F, -0.0349F);
		LeftLeggreenglow.texOffs(26, 100).addBox(0.0F, 8.0F, -2.0F, 2.0F, 4.0F, 2.0F, 0.5F, true);
	}
