...
@OnlyIn(Dist.CLIENT)
public class fourtharmor_legs extends BipedModel {
	...
	public fourtharmor_legs(float modelSize) {
		super(modelSize);
		texWidth = 83;
		texHeight = 240;
		...
		Bodywhite.texOffs(16, 118).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.71F, false);

		Bodyyellow = new ModelRenderer(this);
		Bodyyellow.setPos(0.0F, 0.0F, 0.0F);
		Bodyyellow.texOffs(1, 215).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.71F, false);

		Bodyblue = new ModelRenderer(this);
		Bodyblue.setPos(0.0F, 0.0F, 0.0F);
		Bodyblue.texOffs(26, 213).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.71F, false);

		Bodygray = new ModelRenderer(this);
		Bodygray.setPos(0.0F, 0.0F, 0.0F);
		Bodygray.texOffs(16, 126).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);

		RightLeg2 = new ModelRenderer(this);
		RightLeg2.setPos(-1.9F, 12.0F, 0.0F);
		setRotationAngle(RightLeg2, 0.192F, 0.0F, 0.0349F);
		RightLeg2.texOffs(0, 117).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		RightLegglow.texOffs(17, 140).addBox(-0.9994F, 7.2251F, -1.025F, 2.0F, 5.0F, 2.0F, 0.5F, false);

		LeftLeg2 = new ModelRenderer(this);
		LeftLeg2.setPos(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLeg2, -0.1745F, 0.0F, -0.0349F);
		LeftLeg2.texOffs(40, 117).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
		...
		LeftLegglow.texOffs(27, 140).addBox(-0.9994F, 6.792F, -1.0212F, 2.0F, 5.0F, 2.0F, 0.5F, true);
	}
