...
@OnlyIn(Dist.CLIENT)
public class iceman extends BipedModel {
	...
	public iceman(float modelSize, EquipmentSlotType slot) {
		super(modelSize);
		texWidth = 74;
		texHeight = 142;
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		Headwhite.texOffs(3, 57).addBox(-6.0F, -10.0F, -4.0F, 12.0F, 10.0F, 2.0F, 1.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		RightArmwhite.texOffs(40, 40).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		RightArmwhite.texOffs(40, 56).addBox(-3.0F, 3.6391F, -2.0F, 4.0F, 4.0F, 4.0F, 0.75F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		RightArmblue.texOffs(56, 40).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		RightArmgray.texOffs(56, 56).addBox(-3.0F, 2.6391F, -2.0F, 4.0F, 4.0F, 4.0F, 0.6F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		LeftArmwhite.texOffs(40, 16).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
		LeftArmwhite.texOffs(40, 32).addBox(-1.0F, 3.6391F, -2.0F, 4.0F, 4.0F, 4.0F, 0.75F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		LeftArmblue.texOffs(56, 16).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		LeftArmgray.texOffs(56, 32).addBox(-1.0F, 2.6391F, -2.0F, 4.0F, 4.0F, 4.0F, 0.6F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.FEET) {
		RightLegglow.texOffs(33, 73).addBox(-2.0F, 8.5F, -0.0368F, 4.0F, 4.0F, 4.0F, 1.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.FEET) {
		LeftLegglow.texOffs(52, 73).addBox(-2.0F, 8.2F, -2.0F, 4.0F, 4.0F, 4.0F, 1.0F, true);
		}
	}
