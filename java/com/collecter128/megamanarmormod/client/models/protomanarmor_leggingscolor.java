...
public class protomanarmor_leggingscolor extends BipedModel {
	...
	public protomanarmor_leggingscolor(float modelSize) {
		...
		Bodybelt.setTextureOffset(16, 1).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 4.0F, 4.0F, 1.01F, false);
		...
		Bodyinnerblack.setTextureOffset(16, 19).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.41F, false);

		Bodyinnersilver = new ModelRenderer(this);
		Bodyinnersilver.setRotationPoint(0.0F, 0.0F, 0.0F);
		Bodyinnersilver.setTextureOffset(16, 30).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.41F, false);
		...
		RightLegsilver.setTextureOffset(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);

		RightLegglow = new ModelRenderer(this);
		RightLegglow.setRotationPoint(-1.9F, 12.0F, 0.0F);
		setRotationAngle(RightLegglow, 0.192F, 0.0F, 0.0349F);
		RightLegglow.setTextureOffset(5, 17).addBox(-0.9994F, 7.2251F, -1.025F, 2.0F, 5.0F, 2.0F, 0.5F, false);
		...
		LeftLegsilver.setTextureOffset(40, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);

		LeftLegglow = new ModelRenderer(this);
		LeftLegglow.setRotationPoint(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLegglow, -0.1745F, 0.0F, -0.0349F);
		LeftLegglow.setTextureOffset(45, 17).addBox(-0.9994F, 6.792F, -1.0212F, 2.0F, 5.0F, 2.0F, 0.5F, true);
	}
