...
@OnlyIn(Dist.CLIENT)
public class modelz extends BipedModel {
	...
	public modelz(float modelSize, EquipmentSlotType slot) {
		super(modelSize);
		texWidth = 78;
		texHeight = 203;
		...
		Headblack.texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 7.0F, 8.0F, 0.75F, false);
		}
		
		Headyellow = new ModelRenderer(this);
		Headyellow.setPos(0.0F, 0.0F, 0.0F);
		if(equipmentslot == EquipmentSlotType.HEAD) {
		Headyellow.texOffs(35, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 1.0F, false);
		}
		
		Head2_r1 = new ModelRenderer(this);
		Head2_r1.setPos(0.0F, 24.0F, 0.0F);
		Headyellow.addChild(Head2_r1);
		setRotationAngle(Head2_r1, 0.2618F, 0.0F, 0.0F);
		if(equipmentslot == EquipmentSlotType.HEAD) {
		Head2_r1.texOffs(57, 70).addBox(-4.0F, -24.0F, 12.0F, 8.0F, 15.0F, 1.0F, 1.0F, false);
		}
		...
		setRotationAngle(Head3_r1, 0.0F, 1.0472F, 0.0F);
		if(equipmentslot == EquipmentSlotType.HEAD) {
		Head3_r1.texOffs(9, 83).addBox(-11.0F, -30.0F, -4.0F, 8.0F, 4.0F, 1.0F, 0.5F, false);
		}
		
		Head2_r2 = new ModelRenderer(this);
		Head2_r2.setPos(0.0F, 24.0F, 0.0F);
		Headwhite.addChild(Head2_r2);
		setRotationAngle(Head2_r2, 0.0F, -1.0472F, 0.0F);
		if(equipmentslot == EquipmentSlotType.HEAD) {
		Head2_r2.texOffs(9, 75).addBox(3.0F, -30.0F, -4.0F, 8.0F, 4.0F, 1.0F, 0.5F, false);
		}
