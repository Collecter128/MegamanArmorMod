...
@OnlyIn(Dist.CLIENT)
public class christmas_bit_leggings extends BipedModel {
	...
	public christmas_bit_leggings(float modelSize) {
		super(modelSize);
		texWidth = 79;
		texHeight = 240;
		...
		Bodyred.texOffs(17, 128).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);

		Bodygreen = new ModelRenderer(this);
		Bodygreen.setPos(0.0F, 0.0F, 0.0F);
		Bodygreen.texOffs(17, 121).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 2.0F, 4.0F, 1.3F, false);

		Bodywhite = new ModelRenderer(this);
		Bodywhite.setPos(0.0F, 0.0F, 0.0F);
		Bodywhite.texOffs(51, 197).addBox(-4.0F, 8.0F, -2.0F, 8.0F, 2.0F, 4.0F, 1.3F, false);

		Body_r1 = new ModelRenderer(this);
		Body_r1.setPos(0.0F, 14.0F, 0.0F);
		Bodywhite.addChild(Body_r1);
		...
		RightLegblack.texOffs(1, 126).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		LeftLegblack.texOffs(41, 126).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
