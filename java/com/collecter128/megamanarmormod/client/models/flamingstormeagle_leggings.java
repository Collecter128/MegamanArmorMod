...
@OnlyIn(Dist.CLIENT)
public class flamingstormeagle_leggings extends BipedModel {
	...
	public flamingstormeagle_leggings(float modelSize) {
		super(modelSize);
		texWidth = 73;
		texHeight = 304;
		...
		Bodyblack.texOffs(16, 81).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.61F, false);

		Bodygray = new ModelRenderer(this);
		Bodygray.setPos(0.0F, 0.0F, 0.0F);
		Bodygray.texOffs(16, 89).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		Bodygray.texOffs(1, 274).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.61F, false);
		...
		RightLegblack.texOffs(0, 80).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);

		RightLegred = new ModelRenderer(this);
		RightLegred.setPos(-1.9F, 12.0F, 0.0F);
		setRotationAngle(RightLegred, 0.192F, 0.0F, 0.0349F);
		RightLegred.texOffs(57, 80).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		LeftLegredglow.setPos(0.9F, 12.0F, 1.0F);
		setRotationAngle(LeftLegredglow, -0.1745F, 0.0F, -0.0349F);
		LeftLegredglow.texOffs(26, 100).addBox(0.0F, 8.0F, -2.0F, 2.0F, 4.0F, 2.0F, 0.5F, true);
	}
