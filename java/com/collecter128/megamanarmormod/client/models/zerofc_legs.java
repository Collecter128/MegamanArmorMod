...
public class zerofc_legs extends BipedModel {
	...
	public zerofc_legs(float modelSize) {
		super(modelSize);
		texWidth = 74;
		texHeight = 215;
		...
		Bodyred.texOffs(16, 123).addBox(-4.0F, 8.0F, -2.0F, 8.0F, 4.0F, 4.0F, 1.01F, false);

		Bodyglow = new ModelRenderer(this);
		Bodyglow.setPos(0.0F, 0.0F, 0.0F);
		Bodyglow.texOffs(0, 187).addBox(-4.0F, 7.3F, -2.0F, 8.0F, 4.0F, 4.0F, 1.2F, false);

		Bodyblack = new ModelRenderer(this);
		Bodyblack.setPos(0.0F, 0.0F, 0.0F);
		Bodyblack.texOffs(32, 187).addBox(-4.0F, 8.0F, -2.0F, 8.0F, 4.0F, 4.0F, 1.4F, false);

		Bodygray = new ModelRenderer(this);
		Bodygray.setPos(0.0F, 0.0F, 0.0F);
		Bodygray.texOffs(16, 131).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		...
		RightLegwhite.texOffs(0, 122).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		LeftLegwhite.texOffs(40, 122).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
