...
public class xarmor_main extends BipedModel {
...
//	private final ModelRenderer LeftLeg;
	...
	public xarmor_main(float modelSize) {
		super(modelSize);
		texWidth = 64;
		texHeight = 79;
		...
		Head.texOffs(51, 7).addBox(5.4F, -5.9341F, -0.7842F, 1.0F, 3.0F, 3.0F, 0.5F, false);
		Head.texOffs(34, 7).addBox(-5.981F, -5.938F, -0.747F, 1.0F, 3.0F, 3.0F, 0.5F, false);
		Head.texOffs(0, 45).addBox(-3.6706F, -7.6327F, -3.8533F, 8.0F, 7.0F, 8.0F, 0.55F, false);
		Head.texOffs(15, 30).addBox(-1.0872F, -9.9562F, -4.4855F, 2.0F, 5.0F, 10.0F, 0.4F, false);
		Head.texOffs(43, 10).addBox(-1.0F, -8.8411F, -5.6852F, 2.0F, 2.0F, 1.0F, 0.1F, false);
		
//		HeadGlow = new ModelRenderer(this);
//		HeadGlow.setRotationPoint(0.0F, 0.0F, 0.0F);
//		setRotationAngle(HeadGlow, -0.1047F, 0.0873F, 0.0F);
//		HeadGlow.setTextureOffset(43, 10).addBox(-1.0F, -8.8411F, -5.6852F, 2.0F, 2.0F, 1.0F, 0.1F, false);
...
//		RightArm.setTextureOffset(40, 41).addBox(-3.0F, 3.6391F, -2.0F, 4.0F, 4.0F, 4.0F, 0.75F, false);
//
...
//		LeftArm.setTextureOffset(40, 41).addBox(-1.0F, 3.6391F, -2.0F, 4.0F, 4.0F, 4.0F, 0.75F, false);
//
...
//		this.LeftLeg.copyModelAngles(this.bipedLeftLeg);
		...
		//HeadGlow.render(matrixStack, buffer, 15728640, packedOverlay);
