...
@OnlyIn(Dist.CLIENT)
public class violen_leggings extends BipedModel {
	...
	public violen_leggings(float modelSize) {
		super(modelSize);
		texWidth = 98;
		texHeight = 191;
		...
		RightLegblack.texOffs(0, 87).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);

		RightLegred = new ModelRenderer(this);
		RightLegred.setPos(-1.9F, 12.0F, 0.0F);
		setRotationAngle(RightLegred, 0.192F, 0.0F, 0.0349F);
		RightLegred.texOffs(0, 104).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		LeftLegglow.texOffs(45, 142).addBox(-0.9994F, 6.792F, -1.0212F, 2.0F, 5.0F, 2.0F, 0.5F, true);
	}
