...
@OnlyIn(Dist.CLIENT)
public class copyx_leggings extends BipedModel {
	...
	public copyx_leggings(float modelSize) {
		super(modelSize);
		texWidth = 82;
		texHeight = 164;
		...
		Bodyblue.texOffs(16, 63).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);

		Bodyblack = new ModelRenderer(this);
		Bodyblack.setPos(0.0F, 0.0F, 0.0F);
		Bodyblack.texOffs(16, 74).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		Bodyblack.texOffs(16, 85).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.47F, false);

		Bodydarkblue = new ModelRenderer(this);
		Bodydarkblue.setPos(0.0F, 0.0F, 0.0F);
		Bodydarkblue.texOffs(40, 152).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		...
		RightLegblack.texOffs(44, 87).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		RightLegglow.texOffs(0, 5).addBox(-0.9994F, 8.2251F, -1.025F, 2.0F, 4.0F, 2.0F, 0.5F, false);

		LeftLegblack = new ModelRenderer(this);
		LeftLegblack.setPos(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLegblack, -0.1745F, 0.0F, -0.0349F);
		LeftLegblack.texOffs(61, 87).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
		...
		LeftLegglow.texOffs(24, 5).addBox(-0.9994F, 7.792F, -1.0212F, 2.0F, 4.0F, 2.0F, 0.5F, true);
	}
