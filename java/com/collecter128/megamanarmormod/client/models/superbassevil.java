...
@OnlyIn(Dist.CLIENT)
public class superbassevil extends BipedModel  {
	...
	public superbassevil(float modelSize, EquipmentSlotType slot) {
		super(modelSize);
		texWidth = 89;
		texHeight = 272;
...
equipmentslot = slot;
		...
		ThirdColorDefault = 11350269;//purple
		WhiteColorDefault = 16777215;//Basic White
		GlowyColorDefault = 1011711;//Glow? blue
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		cube_r1.texOffs(61, 102).addBox(3.8F, -7.3064F, 4.0417F, 9.0F, 9.0F, 1.0F, 0.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		LFin_r1.texOffs(1, 116).addBox(4.2961F, -2.8609F, -6.0489F, 11.0F, 1.0F, 12.0F, 0.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		cube_r2.texOffs(61, 112).addBox(-13.0F, -7.086F, 4.4969F, 9.0F, 9.0F, 1.0F, 0.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		RFin_r1.texOffs(1, 102).addBox(-15.2135F, -2.9693F, -6.0F, 11.0F, 1.0F, 12.0F, 0.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		cube_r3.texOffs(61, 81).addBox(3.8F, -7.3064F, 4.0417F, 9.0F, 9.0F, 1.0F, 0.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		LFin_r2.texOffs(3, 144).addBox(4.2961F, -2.8609F, -6.0489F, 11.0F, 1.0F, 12.0F, 0.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		cube_r4.texOffs(62, 91).addBox(-13.0F, -7.086F, 4.4969F, 9.0F, 9.0F, 1.0F, 0.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		RFin_r2.texOffs(3, 130).addBox(-15.2135F, -2.9693F, -6.0F, 11.0F, 1.0F, 12.0F, 0.0F, false);
		}
		...
		setRotationAngle(Headblueglow, -0.1047F, 0.0873F, 0.0F);
		if(equipmentslot == EquipmentSlotType.HEAD) {
		Headblueglow.texOffs(21, 90).addBox(-4.0872F, -5.0932F, -3.2183F, 8.0F, 3.0F, 3.0F, 1.0F, false);
		Headblueglow.texOffs(74, 1).addBox(-1.5114F, -9.8794F, -5.216F, 3.0F, 5.0F, 1.0F, 0.1F, false);
		}
		...
		Bodyblack.texOffs(7, 203).addBox(4.0F, -6.0F, 7.0F, 25.0F, 17.0F, 1.0F, 0.7F, false);
		Bodyblack.texOffs(63, 184).addBox(-3.5F, -1.0F, 3.0F, 7.0F, 8.0F, 4.0F, 0.7F, false);
		Bodyblack.texOffs(5, 180).addBox(-29.0F, -6.0F, 7.0F, 25.0F, 17.0F, 1.0F, 0.7F, false);
		}
		
		Bodypurple = new ModelRenderer(this);
		Bodypurple.setPos(0.0F, 0.0F, 0.0F);
		if(equipmentslot == EquipmentSlotType.CHEST) {
		Bodypurple.texOffs(64, 202).addBox(-3.5F, -1.0F, 3.0F, 7.0F, 8.0F, 4.0F, 0.7F, false);
		Bodypurple.texOffs(16, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 10.0F, 4.0F, 0.7F, false);
		Bodypurple.texOffs(7, 250).addBox(4.0F, -6.0F, 7.0F, 25.0F, 17.0F, 1.0F, 0.7F, false);
		Bodypurple.texOffs(5, 227).addBox(-29.0F, -6.0F, 7.0F, 25.0F, 17.0F, 1.0F, 0.7F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		RightArmblack.texOffs(40, 47).addBox(-6.0F, -2.2019F, -2.0F, 6.0F, 3.0F, 4.0F, 0.8F, false);
		RightArmblack.texOffs(44, 39).addBox(-3.0F, 3.6391F, -2.0F, 4.0F, 4.0F, 4.0F, 0.75F, false);
		}
		...
		RightArmpurple.texOffs(40, 16).addBox(-6.0F, -2.2019F, -2.0F, 6.0F, 3.0F, 4.0F, 0.8F, false);
		}
		...
		LeftArmpurple.texOffs(61, 16).addBox(0.0F, -2.3756F, -1.7921F, 6.0F, 3.0F, 4.0F, 0.8F, false);
		}
		...
		RightLegblack.texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 1.0F, false);
		}
