...
public class megamanarmor_chestplatecolorTest2 <T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead{
	...
	//@Override
	public megamanarmor_chestplatecolorTest2(Function<ResourceLocation, RenderType> renderTypeIn, float modelSizeIn, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
	...
	}//extends BipedModel //<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead
//	//private final ModelRenderer Head;
//	public final ModelRenderer Body;
//	public final ModelRenderer RightArm;
//	public final ModelRenderer LeftArm;
...
//
//	public megamanarmor_chestplatecolorTest2(float modelSize) {
//		super(modelSize);
//		textureWidth = 64;
//		textureHeight = 71;
//
