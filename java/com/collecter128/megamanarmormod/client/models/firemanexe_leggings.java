...
@OnlyIn(Dist.CLIENT)
public class firemanexe_leggings extends BipedModel {
	...
	public firemanexe_leggings(float modelSize) {
		super(modelSize);
		texWidth = 74;
		texHeight = 154;
		...
		Bodyred.texOffs(16, 119).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);

		Bodygray = new ModelRenderer(this);
		Bodygray.setPos(0.0F, 0.0F, 0.0F);
		Bodygray.texOffs(16, 127).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.7F, false);

		RightLegred = new ModelRenderer(this);
		RightLegred.setPos(-2.9F, 12.0F, 0.0F);
		setRotationAngle(RightLegred, 0.192F, 0.0F, 0.0349F);
		RightLegred.texOffs(0, 118).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);

		LeftLegred = new ModelRenderer(this);
		LeftLegred.setPos(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLegred, -0.1745F, 0.0F, -0.0349F);
		LeftLegred.texOffs(40, 118).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
	}
