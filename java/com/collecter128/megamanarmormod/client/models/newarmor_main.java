...
//	}
	...
	public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
		...
		RightArmglow.render(matrixStack, buffer, 15728640, packedOverlay, fred, fgreen, fblue, alpha);
		this.LeftArmglow.copyFrom(this.leftArm);
		LeftArmglow.render(matrixStack, buffer, 15728640, packedOverlay, fred, fgreen, fblue, alpha);
