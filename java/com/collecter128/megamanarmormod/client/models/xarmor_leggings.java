...
public class xarmor_leggings extends BipedModel {
	private final ModelRenderer Body;
	private final ModelRenderer RightLeg;
	private final ModelRenderer LeftLeg;

	public xarmor_leggings(float modelSize) {
		super(modelSize);
		textureWidth = 64;
		textureHeight = 32;
		...
		Body.setTextureOffset(16, 17).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 4.0F, 4.0F, 1.01F, false);
