...
@OnlyIn(Dist.CLIENT)
public class bassexehubstyle_main extends BipedModel {
	...
	private final ModelRenderer LeftArmglowgreen;
	...
	public bassexehubstyle_main(float modelSize, EquipmentSlotType slot) {
		super(modelSize);
		texWidth = 96;
		texHeight = 203;
		...
		FourthColorDefault = 65428; //green
		...
		if(equipmentslot == EquipmentSlotType.HEAD) {
		Headglowgreen.texOffs(0, 185).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 1.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		Bodyglowgreen.texOffs(1, 99).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 10.0F, 4.0F, 0.51F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.CHEST) {
		RightArmglowgreen.texOffs(61, 46).addBox(-3.0F, 1.6391F, -2.0F, 4.0F, 6.0F, 4.0F, 0.75F, false);
		}
		...
		LeftArmglowgreen = new ModelRenderer(this);
		LeftArmglowgreen.setPos(5.0F, 2.0F, 0.0F);
		setRotationAngle(LeftArmglowgreen, 0.2094F, 0.0F, 0.0F);
		if(equipmentslot == EquipmentSlotType.CHEST) {
		LeftArmglowgreen.texOffs(44, 46).addBox(-1.0F, 1.6391F, -2.0F, 4.0F, 6.0F, 4.0F, 0.75F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.FEET) {
		RightLegglowgreen.texOffs(78, 30).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 1.0F, false);
		}
		...
		if(equipmentslot == EquipmentSlotType.FEET) {
		LeftLegglowgreen.texOffs(78, 46).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 1.0F, true);
		}
	}
...
//	}
	...
	public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
		...
		this.LeftArmglowgreen.copyFrom(this.leftArm);
		LeftArmglowgreen.render(matrixStack, buffer, 0xF000F0, packedOverlay, fred, fgreen, fblue, alpha);
