...
@OnlyIn(Dist.CLIENT)
public class modelz_leggings extends BipedModel {
	...
	public modelz_leggings(float modelSize) {
		super(modelSize);
		texWidth = 78;
		texHeight = 203;
		...
		RightLegblack.texOffs(60, 125).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, 0.6F, false);
		...
		LeftLegblack.texOffs(60, 135).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, 0.6F, true);
