...
@OnlyIn(Dist.CLIENT)
public class bassexehubstyle_leggings extends BipedModel {
	...
	public bassexehubstyle_leggings(float modelSize) {
		super(modelSize);
		texWidth = 96;
		texHeight = 203;
		...
		Bodyglowgreen.texOffs(18, 138).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		...
		RightLegglowgreen.setPos(-2.9F, 12.0F, 0.0F);
		setRotationAngle(RightLegglowgreen, 0.192F, 0.0F, 0.0349F);
		RightLegglowgreen.texOffs(1, 138).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		LeftLegglowgreen.texOffs(43, 138).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
	}
