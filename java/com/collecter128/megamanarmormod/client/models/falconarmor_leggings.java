...
@OnlyIn(Dist.CLIENT)
public class falconarmor_leggings extends BipedModel {
	...
	public falconarmor_leggings(float modelSize) {
		super(modelSize);
		texWidth = 83;
		texHeight = 310;
		...
		Bodywhite.texOffs(16, 116).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);
		Bodywhite.texOffs(16, 109).addBox(-4.0F, 9.0F, -2.0F, 8.0F, 2.0F, 4.0F, 1.3F, false);

		Bodyblue = new ModelRenderer(this);
		Bodyblue.setPos(0.0F, 0.0F, 0.0F);
		Bodyblue.texOffs(58, 220).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);

		Bodyred = new ModelRenderer(this);
		Bodyred.setPos(0.0F, 0.0F, 0.0F);
		Bodyred.texOffs(58, 228).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.01F, false);
