...
@OnlyIn(Dist.CLIENT)
public class superbassevil_legs extends BipedModel  {
	...
	public superbassevil_legs(float modelSize) {
		super(modelSize);
		texWidth = 89;
		texHeight = 272;
		...
		Bodypurple.texOffs(17, 167).addBox(-4.5F, 9.0F, -2.5F, 9.0F, 4.0F, 5.0F, 0.51F, false);
