...
@OnlyIn(Dist.CLIENT)
public class gutsman_legs extends BipedModel {
	...
	public gutsman_legs(float modelSize) {
		super(modelSize);
		texWidth = 75;
		texHeight = 198;
		...
		Bodyred.texOffs(16, 107).addBox(-4.0F, 8.0F, -2.0F, 8.0F, 4.0F, 4.0F, 0.61F, false);
		...
		RightLegyellow.texOffs(0, 97).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		RightLegglow.texOffs(57, 98).addBox(0.0F, 9.0F, -2.0F, 2.0F, 3.0F, 2.0F, 0.5F, false);
		...
		LeftLegyellow.texOffs(40, 97).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
		...
		LeftLegglow.texOffs(57, 114).addBox(0.0F, 8.0F, -2.0F, 2.0F, 4.0F, 2.0F, 0.5F, true);
	}
