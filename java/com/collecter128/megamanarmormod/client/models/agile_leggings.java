...
@OnlyIn(Dist.CLIENT)
public class agile_leggings extends BipedModel {
	...
	public agile_leggings(float modelSize) {
		super(modelSize);
		texWidth = 89;
		texHeight = 274;
		...
		Bodypurple.setPos(0.0F, 2.0F, 0.0F);
		Bodypurple.texOffs(17, 70).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 7.0F, 4.0F, 1.01F, false);

		Bodyred = new ModelRenderer(this);
		Bodyred.setPos(0.0F, 2.0F, 0.0F);
		Bodyred.texOffs(59, 213).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 7.0F, 4.0F, 1.01F, false);

		Bodygreen = new ModelRenderer(this);
		Bodygreen.setPos(0.0F, 2.0F, 0.0F);
		Bodygreen.texOffs(59, 226).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 7.0F, 4.0F, 1.01F, false);

		Bodygray = new ModelRenderer(this);
		Bodygray.setPos(0.0F, 0.0F, 0.0F);
		Bodygray.texOffs(19, 108).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		Bodygray.texOffs(19, 101).addBox(-4.0F, 10.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.51F, false);
		...
		RightLegblack.texOffs(3, 83).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);

		RightLeggray = new ModelRenderer(this);
		RightLeggray.setPos(-1.9F, 12.0F, 0.0F);
		setRotationAngle(RightLeggray, 0.192F, 0.0F, 0.0349F);
		RightLeggray.texOffs(36, 159).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);
		...
		RightLeglightblue.texOffs(3, 99).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, false);

		RightLegglow = new ModelRenderer(this);
		RightLegglow.setPos(-1.9F, 12.0F, 0.0F);
		setRotationAngle(RightLegglow, 0.192F, 0.0F, 0.0349F);
		RightLegglow.texOffs(21, 87).addBox(-0.9994F, 7.2251F, -1.025F, 2.0F, 5.0F, 2.0F, 0.5F, false);

		LeftLegblack = new ModelRenderer(this);
		LeftLegblack.setPos(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLegblack, -0.1745F, 0.0F, -0.0349F);
		LeftLegblack.texOffs(43, 83).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);

		LeftLeggray = new ModelRenderer(this);
		LeftLeggray.setPos(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLeggray, -0.1745F, 0.0F, -0.0349F);
		LeftLeggray.texOffs(53, 159).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);
		...
		LeftLeglightblue.texOffs(43, 99).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.5F, true);

		LeftLegglow = new ModelRenderer(this);
		LeftLegglow.setPos(1.9F, 12.0F, 0.0F);
		setRotationAngle(LeftLegglow, -0.1745F, 0.0F, -0.0349F);
		LeftLegglow.texOffs(31, 87).addBox(-0.9994F, 6.792F, -1.0212F, 2.0F, 5.0F, 2.0F, 0.5F, true);
	}
