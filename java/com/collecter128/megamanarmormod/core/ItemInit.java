...
public class ItemInit {
	...
	public static final RegistryObject<Item> ChristmasBell = Items.register("christmas_bell",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> ChristmasStocking = Items.register("christmas_stocking",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	
	public static final RegistryObject<Item> HalloweenCandy = Items.register("halloween_candy",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	
	public static final RegistryObject<Item> NewYearKoban = Items.register("newyear_koban",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> ValentinesChocolate = Items.register("valentines_chocolate",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	...
	public static final RegistryObject<Item> EnkerMirror = Items.register("enker_mirror",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	...
	public static final RegistryObject<Item> StormEagleFeather = Items.register("stormeagle_feather",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> KuwangerBoomerang = Items.register("kuwanger_boomerang",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	...
	public static final RegistryObject<Item> CielSystem = Items.register("ciel_system",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	...
	public static final RegistryObject<Item> DarkData = Items.register("data_dark",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> LightData = Items.register("data_light",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	...
	public static final RegistryObject<Item> World3Data = Items.register("data_world3",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> AsteroidData = Items.register("data_asteroid",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	...
	public static final RegistryObject<Item> RefractershardSmall = Items.register("refractershard_small",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> RefractershardMedium = Items.register("refractershard_medium",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> RefractershardLarge = Items.register("refractershard_large",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	public static final RegistryObject<Item> RefractershardVeryLarge = Items.register("refractershard_verylarge",
			() -> new Item(new Item.Properties().tab(MegamanArmorMod.MMMaterialsTab)));
	...
	public static final RegistryObject<Item> EnkerColorizer = Items.register("colorizerenker",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16766991, /*Secondary*/6906571, /*ThirdColor*/16615688, 
							/*WhiteColor*/16777215, /*Glow Bits*/16711680, /*GreyColor*/8882055, 
							/*FourthColor*/8882055, /*FifthColor*/16711680}));
	...
	public static final RegistryObject<Item> EnkerGoalieColorizer = Items.register("colorizerenkergoalie",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/8757503, /*Secondary*/16341129, /*ThirdColor*/8757503, 
							/*WhiteColor*/16777215, /*Glow Bits*/16711680, /*GreyColor*/8882055, 
							/*FourthColor*/8882055, /*FifthColor*/16711680}));
	...
	public static final RegistryObject<Item> MegamanZero2pSVCChaosColorizer = Items.register("colorizermegamanzero2psvcchaos",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/4746669, /*Secondary*/7688571, /*ThirdColor*/16297049, 
							/*WhiteColor*/16777215, /*Glow Bits*/2282382, /*GreyColor*/9659807, 
							/*FourthColor*/11974089, /*FifthColor*/-1}));
	//Street Fighter X All Capcom
	public static final RegistryObject<Item> MegamanZeroRPlusColorizer = Items.register("colorizermegamanzerorplus",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/7046525, /*Secondary*/7688571, /*ThirdColor*/10264171, 
							/*WhiteColor*/16777215, /*Glow Bits*/2414208, /*GreyColor*/9659807, 
							/*FourthColor*/11974089, /*FifthColor*/-1}));
	
	public static final RegistryObject<Item> ZeroEnergyFormMZ2Colorizer = Items.register("colorizerformenergymz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16774953, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroXFormMZ2Colorizer = Items.register("colorizerformxmz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/7592680, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroDefenceFormMZ2Colorizer = Items.register("colorizerformdefencemz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/9895680, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroEraseFormMZ2Colorizer = Items.register("colorizerformerasemz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16674201, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroActiveFormMZ2Colorizer = Items.register("colorizerformactivemz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16684330, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroPowerFormMZ2Colorizer = Items.register("colorizerformpowermz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/12546512, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroRiseFormMZ2Colorizer = Items.register("colorizerformrisemz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/11782073, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroProtoFormMZ2Colorizer = Items.register("colorizerformprotomz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/6068602, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroUltimateFormMZ2Colorizer = Items.register("colorizerformultimatemz2",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16392960, /*Secondary*/5776220, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	
	public static final RegistryObject<Item> ZeroIceChipMZ3Colorizer = Items.register("colorizerchipicemz3",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/5745355, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroThunderChipMZ3Colorizer = Items.register("colorizerchipthundermz3",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16568610, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroFlameChipMZ3Colorizer = Items.register("colorizerchipflamemz3",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16620040, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroLightChipMZ3Colorizer = Items.register("colorizerchiplightmz3",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/7927678, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroAbsorberChipMZ3Colorizer = Items.register("colorizerchipabsorbermz3",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/10076853, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroHardModeMZ3Colorizer = Items.register("colorizermegamanzero3hardmode",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/7247487, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	
	public static final RegistryObject<Item> ZeroAbsorberChipMZ4Colorizer = Items.register("colorizerchipabsorbermz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/6274865, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroRollingChipMZ4Colorizer = Items.register("colorizerchiprollingmz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16751396, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroEraseChipMZ4Colorizer = Items.register("colorizerchiperasemz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/15623088, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroStrongChipMZ4Colorizer = Items.register("colorizerchipstrongmz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16732682, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroStrongerChipMZ4Colorizer = Items.register("colorizerchipstrongermz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16743690, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroStrongestChipMZ4Colorizer = Items.register("colorizerchipstrongestmz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16762890, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroReflectChipMZ4Colorizer = Items.register("colorizerchipreflectmz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/11980480, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroExtendChipMZ4Colorizer = Items.register("colorizerchipextendmz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/5413119, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroElfChipMZ4Colorizer = Items.register("colorizerchipelfmz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/10420159, /*Secondary*/2049843, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	public static final RegistryObject<Item> ZeroJunkChipsMZ4Colorizer = Items.register("colorizerchipjunkmz4",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/6658679, /*Secondary*/-1, /*ThirdColor*/-1, 
							/*WhiteColor*/-1, /*Glow Bits*/-1, /*GreyColor*/-1, 
							/*FourthColor*/-1, /*FifthColor*/-1}));
	...
	public static final RegistryObject<Item> NumbermanexeColorizer = Items.register("colorizernumbermanexe",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/10091319, /*Secondary*/14532503, /*ThirdColor*/16600343, 
							/*WhiteColor*/12305609, /*Glow Bits*/16635947, /*GreyColor*/11579568, 
							/*FourthColor*/6710886, /*FifthColor*/16635947}));
	public static final RegistryObject<Item> NumbermanexeDSColorizer = Items.register("colorizernumbermanexeds",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/7877055, /*Secondary*/9689008, /*ThirdColor*/15807117, 
							/*WhiteColor*/11908533, /*Glow Bits*/5439464, /*GreyColor*/9868950, 
							/*FourthColor*/4671303, /*FifthColor*/5439464}));
	public static final RegistryObject<Item> NumbermanexeSPColorizer = Items.register("colorizernumbermanexesp",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/1040384, /*Secondary*/13752399, /*ThirdColor*/16056384, 
							/*WhiteColor*/13422731, /*Glow Bits*/16772946, /*GreyColor*/9868950, 
							/*FourthColor*/6052956, /*FifthColor*/16772946}));
	
	public static final RegistryObject<Item> FiremanexeColorizer = Items.register("colorizerfiremanexe",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/13576746, /*Secondary*/2786767, /*ThirdColor*/16566843, 
							/*WhiteColor*/16777215, /*Glow Bits*/16770411, /*GreyColor*/10724259, 
							/*FourthColor*/13212475, /*FifthColor*/16546077}));
	public static final RegistryObject<Item> FiremanexeDSColorizer = Items.register("colorizerfiremanexeds",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/12203002, /*Secondary*/3822974, /*ThirdColor*/16355866, 
							/*WhiteColor*/16777215, /*Glow Bits*/14449365, /*GreyColor*/9737364, 
							/*FourthColor*/12203002, /*FifthColor*/6756328}));
	public static final RegistryObject<Item> FiremanexeSPColorizer = Items.register("colorizerfiremanexesp",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16011536, /*Secondary*/5536176, /*ThirdColor*/16363802, 
							/*WhiteColor*/16777215, /*Glow Bits*/16433986, /*GreyColor*/9938874, 
							/*FourthColor*/12542498, /*FifthColor*/15210311}));
	...
	public static final RegistryObject<Item> HarpNoteDXColorizer = Items.register("colorizerharpnotedx",
			() -> new ArmorColorizer(new Item.Properties().tab(MegamanArmorMod.ArmorColorizer), 
					new int[]{/*Main*/16174852, /*Secondary*/16751006, /*ThirdColor*/16768845, 
							/*WhiteColor*/16252805, /*Glow Bits*/391167, /*GreyColor*/16252805, 
							/*FourthColor*/7161450, /*FifthColor*/-1}));
	...
	//This colorizer is actually a SF X All Capcom colorizer
	...
	public static final RegistryObject<Item> Enker_Head = Items.register("enker_head",
			() -> new EnkerArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Enker_Body = Items.register("enker_body",
			() -> new EnkerArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Enker_Legs = Items.register("enker_legs",
			() -> new EnkerArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Enker_Arms = Items.register("enker_arms",
			() -> new EnkerArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> BladeArmor_Head = Items.register("bladearmor_head",
			() -> new BladeArmor(ArmorMaterials.ThirdXArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> BladeArmor_Body = Items.register("bladearmor_body",
			() -> new BladeArmor(ArmorMaterials.ThirdXArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> BladeArmor_Legs = Items.register("bladearmor_legs",
			() -> new BladeArmor(ArmorMaterials.ThirdXArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> BladeArmor_Arms = Items.register("bladearmor_arms",
			() -> new BladeArmor(ArmorMaterials.ThirdXArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> ZeroAwakened_Head = Items.register("zeroawakened_head",
			() -> new ZeroAwakenedHelmet(ArmorMaterials.ZeroArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> Zsabermz = Items.register("zsabermz",
			() -> new SwordItem(ItemTier.DIAMOND, 3, -2.4F, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> ZsabermzPlus1 = Items.register("zsabermzplus1",
			() -> new SwordItem(ItemTier.DIAMOND, 4, -2.4F, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> ZsabermzPlus2 = Items.register("zsabermzplus2",
			() -> new SwordItem(ItemTier.DIAMOND, 5, -2.4F, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> Sigma2_Head = Items.register("sigma2_head",
			() -> new Sigma2Armor(ArmorMaterials.SigmaArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Sigma2_Body = Items.register("sigma2_body",
			() -> new Sigma2Armor(ArmorMaterials.SigmaArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Sigma2_Legs = Items.register("sigma2_legs",
			() -> new Sigma2Armor(ArmorMaterials.SigmaArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Sigma2_Arms = Items.register("sigma2_arms",
			() -> new Sigma2Armor(ArmorMaterials.SigmaArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	
	public static final RegistryObject<Item> StormEagle_Head = Items.register("stormeagle_head",
			() -> new StormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> StormEagle_Body = Items.register("stormeagle_body",
			() -> new StormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> StormEagle_Legs = Items.register("stormeagle_legs",
			() -> new StormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> StormEagle_Arms = Items.register("stormeagle_arms",
			() -> new StormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	
	public static final RegistryObject<Item> BoomerKuwanger_Head = Items.register("boomerkuwanger_head",
			() -> new BoomerKuwangerArmor(ArmorMaterials.XArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> BoomerKuwanger_Body = Items.register("boomerkuwanger_body",
			() -> new BoomerKuwangerArmor(ArmorMaterials.XArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> BoomerKuwanger_Legs = Items.register("boomerkuwanger_legs",
			() -> new BoomerKuwangerArmor(ArmorMaterials.XArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> BoomerKuwanger_Arms = Items.register("boomerkuwanger_arms",
			() -> new BoomerKuwangerArmor(ArmorMaterials.XArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> Ciel_Head = Items.register("ciel_head",
			() -> new CielArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Ciel_Body = Items.register("ciel_body",
			() -> new CielArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Ciel_Legs = Items.register("ciel_legs",
			() -> new CielArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Ciel_Arms = Items.register("ciel_arms",
			() -> new CielArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> UncustomizedNavi_Head = Items.register("uncustomizednavi_head",
			() -> new UncustomizedNaviArmor(ArmorMaterials.MegamanExeArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> UncustomizedNavi_Body = Items.register("uncustomizednavi_body",
			() -> new UncustomizedNaviArmor(ArmorMaterials.MegamanExeArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> UncustomizedNavi_Legs = Items.register("uncustomizednavi_legs",
			() -> new UncustomizedNaviArmor(ArmorMaterials.MegamanExeArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> UncustomizedNavi_Arms = Items.register("uncustomizednavi_arms",
			() -> new UncustomizedNaviArmor(ArmorMaterials.MegamanExeArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	
	public static final RegistryObject<Item> Numbermanexe_Head = Items.register("numbermanexe_head",
			() -> new NumbermanexeArmor(ArmorMaterials.PlusDataArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Numbermanexe_Body = Items.register("numbermanexe_body",
			() -> new NumbermanexeArmor(ArmorMaterials.PlusDataArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Numbermanexe_Legs = Items.register("numbermanexe_legs",
			() -> new NumbermanexeArmor(ArmorMaterials.PlusDataArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Numbermanexe_Arms = Items.register("numbermanexe_arms",
			() -> new NumbermanexeArmor(ArmorMaterials.PlusDataArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	
	public static final RegistryObject<Item> Firemanexe_Head = Items.register("firemanexe_head",
			() -> new FiremanexeArmor(ArmorMaterials.FireDataArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Firemanexe_Body = Items.register("firemanexe_body",
			() -> new FiremanexeArmor(ArmorMaterials.FireDataArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Firemanexe_Legs = Items.register("firemanexe_legs",
			() -> new FiremanexeArmor(ArmorMaterials.FireDataArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Firemanexe_Arms = Items.register("firemanexe_arms",
			() -> new FiremanexeArmor(ArmorMaterials.FireDataArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> LyraWeaponDX = Items.register("lyra_weapondx",
			() -> new LyraWeapon(new Item.Properties().tab(MegamanArmorMod.MMTab)));//MegamanArmorMod.ArmorItems_Group
	
	public static final RegistryObject<Item> Jammer_Head = Items.register("jammer_head",
			() -> new JammerArmor(ArmorMaterials.StarforceFMArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Jammer_Body = Items.register("jammer_body",
			() -> new JammerArmor(ArmorMaterials.StarforceFMArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Jammer_Legs = Items.register("jammer_legs",
			() -> new JammerArmor(ArmorMaterials.StarforceFMArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Jammer_Arms = Items.register("jammer_arms",
			() -> new JammerArmor(ArmorMaterials.StarforceFMArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> Servbot_Head = Items.register("servbot_head",
			() -> new ServbotArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Servbot_Body = Items.register("servbot_body",
			() -> new ServbotArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Servbot_Legs = Items.register("servbot_legs",
			() -> new ServbotArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Servbot_Arms = Items.register("servbot_arms",
			() -> new ServbotArmor(ArmorMaterials.MegamanArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> Over1Armor_Head = Items.register("over1_head",
			() -> new Over1Armor(ArmorMaterials.MegamanArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Over1Armor_Body = Items.register("over1_body",
			() -> new Over1Armor(ArmorMaterials.MegamanArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Over1Armor_Legs = Items.register("over1_legs",
			() -> new Over1Armor(ArmorMaterials.MegamanArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> Over1Armor_Arms = Items.register("over1_arms",
			() -> new Over1Armor(ArmorMaterials.MegamanArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	...
	public static final RegistryObject<Item> HalloweenVile_Head = Items.register("halloweenvile_head",
			() -> new HalloweenVileArmor(ArmorMaterials.XArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> HalloweenVile_Body = Items.register("halloweenvile_body",
			() -> new HalloweenVileArmor(ArmorMaterials.XArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> HalloweenVile_Legs = Items.register("halloweenvile_legs",
			() -> new HalloweenVileArmor(ArmorMaterials.XArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> HalloweenVile_Arms = Items.register("halloweenvile_arms",
			() -> new HalloweenVileArmor(ArmorMaterials.XArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	
	public static final RegistryObject<Item> ChristmasBit_Head = Items.register("christmas_bit_head",
			() -> new ChristmasBitArmor(ArmorMaterials.XArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> ChristmasBit_Body = Items.register("christmas_bit_body",
			() -> new ChristmasBitArmor(ArmorMaterials.XArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> ChristmasBit_Legs = Items.register("christmas_bit_legs",
			() -> new ChristmasBitArmor(ArmorMaterials.XArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> ChristmasBit_Arms = Items.register("christmas_bit_arms",
			() -> new ChristmasBitArmor(ArmorMaterials.XArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	
	public static final RegistryObject<Item> flamingStormEagle_Head = Items.register("flamingstormeagle_head",
			() -> new flamingStormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.HEAD, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> flamingStormEagle_Body = Items.register("flamingstormeagle_body",
			() -> new flamingStormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.CHEST, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> flamingStormEagle_Legs = Items.register("flamingstormeagle_legs",
			() -> new flamingStormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.LEGS, new Item.Properties().tab(MegamanArmorMod.MMTab)));
	public static final RegistryObject<Item> flamingStormEagle_Arms = Items.register("flamingstormeagle_arms",
			() -> new flamingStormEagleArmor(ArmorMaterials.XArmor, EquipmentSlotType.FEET, new Item.Properties().tab(MegamanArmorMod.MMTab)));
