...
public class GreenMysteryDataBlock extends BreakableBlock{
	
	   public GreenMysteryDataBlock(Properties properties) {
		super(properties);
	   }
	...
	/**
	   ...
	   //public void onRemove(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
	      if (!worldIn.isClientSide) {
	    	 ...
	    	 switch(RandomInt) {
	    	 	case 0: 
	    	 		itemstackIn = new ItemStack(ItemInit.Zenny.get());
	    	 		break;
//	    	 	case 1: 
//	    	 		itemstackIn = new ItemStack(ItemInit);
//	    	 		break;
//	    	 	case 2: 
