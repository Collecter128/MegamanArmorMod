	      ...
	      if (!worldIn.isClientSide) {
	    	 ...
	    	 //Megaman Soccer
	    	 	...
	    	 	case 304: 
	    	 		...
	    	 		break;
	    	 	case 305: 
	    	 		itemstackIn = new ItemStack(ItemInit.ProtomanExeDSColorizer.get());
	    	 		break;
	    	 	case 306: 
	    	 		itemstackIn = new ItemStack(ItemInit.ProtomanExeSPColorizer.get());
	    	 		break;
	    	 	case 307: 
	    	 		itemstackIn = new ItemStack(ItemInit.ProtomanExeDarkBCSColorizer.get());
	    	 		break;
	    	 		
	    	 	case 315: 
	    	 		itemstackIn = new ItemStack(ItemInit.GutsmanExeColorizer.get());
	    	 		break;
	    	 	case 316: 
	    	 		itemstackIn = new ItemStack(ItemInit.GutsmanExeDSColorizer.get());
	    	 		break;
	    	 	case 317: 
	    	 	...
	    	 	case 354: 
	    	 		itemstackIn = new ItemStack(ItemInit.NumbermanexeColorizer.get());
	    	 		break;
	    	 	case 355: 
	    	 		itemstackIn = new ItemStack(ItemInit.NumbermanexeDSColorizer.get());
	    	 		break;
	    	 	case 356: 
	    	 		itemstackIn = new ItemStack(ItemInit.NumbermanexeSPColorizer.get());
	    	 		break;
	    	 		
	    	 	case 357: 
	    	 		itemstackIn = new ItemStack(ItemInit.FiremanexeColorizer.get());
	    	 		break;
	    	 	case 358: 
	    	 		itemstackIn = new ItemStack(ItemInit.FiremanexeDSColorizer.get());
	    	 		break;
	    	 	case 359: 
	    	 		itemstackIn = new ItemStack(ItemInit.FiremanexeSPColorizer.get());
	    	 		break;
	    	 		
	    	 	case 322: 
	    	 		itemstackIn = new ItemStack(ItemInit.BassexeColorizer.get());
	    	 		break;
	    	 	case 323: 
	    	 		itemstackIn = new ItemStack(ItemInit.BassexeXXColorizer.get());
	    	 		break;
	    	 	...
	    	 	case 353: 
	    	 		itemstackIn = new ItemStack(ItemInit.HarpNoteDXColorizer.get());
	    	 		break;
