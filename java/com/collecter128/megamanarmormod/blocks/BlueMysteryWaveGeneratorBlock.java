...
public class BlueMysteryWaveGeneratorBlock extends Block{
	public static final DirectionProperty FACING = HorizontalBlock.FACING;
	
	   public BlueMysteryWaveGeneratorBlock(Properties properties) {
		super(properties);
		      ...
		      if (itemstack.isEmpty()) {
		         ...
		         if(item == Items.REDSTONE && (p_225533_2_.getBlockState(p_225533_3_.above()) == Blocks.AIR.defaultBlockState()) ) {
		        	 if (!p_225533_2_.isClientSide) {
			            	...
			            	//p_225533_4_.inventory.add(new ItemStack(BlockInit.BlueMysterywave.get(), 1));
			            	popResource(p_225533_2_, p_225533_3_.above(), new ItemStack(BlockInit.BlueMysterywave.get(), 1));
			            	//p_225533_2_.setBlock(p_225533_3_.above(), BlockInit.BlueMysterywave.get().defaultBlockState(), 0);
