...
import com.collecter128.megamanarmormod.client.models.via_legs;
import com.collecter128.megamanarmormod.client.models.via_main;
...
public class ViaArmor extends ArmorItem{
	
	public int MainColorDefault = 6082278;//Main Body Color light blue
	public int SecondaryColorDefault = 3421837;//Secondary dark blue
	public int ThirdColorDefault = 16767058; //yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 15414067;//Glow? red
	public int GrayColorDefault = 10921638;//gray
	public int FourthColorDefault = 5539545; //blue
	...
	public ViaArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			via_main model = new via_main(1.0f, armorSlot);
...
//	    	  itemStack.getOrCreateTagElement("displaymm").putInt("FourthColor", FourthColorDefault);
        ...
        return (A) model;
			...
			via_legs model = new via_legs(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/via.png";
    }
