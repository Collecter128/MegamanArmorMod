...
import com.collecter128.megamanarmormod.client.models.uncustomizednavi;
import com.collecter128.megamanarmormod.client.models.uncustomizednavi_leggings;
...
public class UncustomizedNaviArmor extends ArmorItem{
	
	public int MainColorDefault = 5804917;//Main Green
	public int SecondaryColorDefault = 7712415;//Secondary Light Blue
	public int ThirdColorDefault = 8553090; //Gray
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 0;//Glow? Black
	public int GrayColorDefault = 13552310;//Light Gray
	public int FourthColorDefault = 5804917; //Green
	public int FifthColorDefault = 5333642; //Blue
	...
	public UncustomizedNaviArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			uncustomizednavi model = new uncustomizednavi(1.0f, armorSlot);
        ...
        return (A) model;
			...
			uncustomizednavi_leggings model = new uncustomizednavi_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/uncustomizednavi.png";
    }
