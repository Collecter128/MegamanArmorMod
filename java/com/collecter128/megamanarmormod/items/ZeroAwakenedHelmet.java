...
import com.collecter128.megamanarmormod.client.models.zeroawakenedhelmet;
...
public class ZeroAwakenedHelmet extends ArmorItem{
	...
	public ZeroAwakenedHelmet(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		zeroawakenedhelmet model = new zeroawakenedhelmet(1.0f);
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/zeroawakenedhelmet.png";
    }
