...
public class NormnaviArmor extends ArmorItem{
	...
	public int MainColorDefault = 7130142;//Main Body Color Green
	public int SecondaryColorDefault = 15389210;//Secondary Yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int ThirdColorDefault = 6381921; //Black
	public int GlowyColorDefault = 2292973;//Glow? LightBlue
	public int GrayColorDefault = 6122100;//Gray
	public int FourthColorDefault = 6122100; //???
	...
	public NormnaviArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	if(armorSlot == EquipmentSlotType.HEAD) {
		normnavi model = new normnavi(1.0f, armorSlot);
		...
		normnavi_leggings model = new normnavi_leggings(1.0f);
		model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
