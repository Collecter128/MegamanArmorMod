...
import com.collecter128.megamanarmormod.client.models.zeroixarmor;
...
public class ZeroiXArmor extends ArmorItem{
	
	public int MainColorDefault = 16711680;//Main Body Color 
	public int SecondaryColorDefault = 2171169;//Secondary 
	public int ThirdColorDefault = 16763151;//gold/yellow
	public int WhiteColorDefault = 16777215;//white
	public int GlowyColorDefault = 2448340;//glow blue
	public int GrayColorDefault = 16777215;//gray
	public int FourthColorDefault = 1420413; //Greenish shoulders
	...
	public ZeroiXArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		zeroixarmor model = new zeroixarmor(1.0f, armorSlot);
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/zeroarmorix.png";
    }
