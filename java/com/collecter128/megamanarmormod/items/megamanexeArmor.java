...
import com.collecter128.megamanarmormod.client.models.megamanexe_leggings;
import com.collecter128.megamanarmormod.client.models.megamanexe_main;
...
public class megamanexeArmor extends ArmorItem{
	
	public int MainColorDefault = 3425221;//Main Body Color 
	public int SecondaryColorDefault = 3225453;//Secondary 
	public int ThirdColorDefault = 16630571;
	public int WhiteColorDefault = 2378966;
	public int GlowyColorDefault = 16646401;
	public int GrayColorDefault = 2378966;
	public int FourthColorDefault = 1244562;
	...
	public megamanexeArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			megamanexe_main model = new megamanexe_main(1.0f, armorSlot);
        ...
        return (A) model;
			...
			megamanexe_leggings model = new megamanexe_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/megamanexe.png";
    }
