...
public class ModelXArmor extends ArmorItem{
	
	public int MainColorDefault = 4024831;//Main Body Blue
	public int SecondaryColorDefault = 7261149;//Secondary Light blue
	public int ThirdColorDefault = 16761907; //Gold Color
	public int WhiteColorDefault = 16641486;//Cream White
	public int GlowyColorDefault = 16722262;// Redish color
	...
	public ModelXArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			modelx_main model = new modelx_main(1.0f, armorSlot);
        ...
        return (A) model;
			...
			modelx_leggings model = new modelx_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/modelx.png";
    }
