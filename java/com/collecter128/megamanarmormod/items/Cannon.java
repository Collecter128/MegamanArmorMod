...
public class Cannon extends ShootableItem{

	public Cannon(Properties p_i50040_1_) {
		super(p_i50040_1_);
...
//	static int firetime = 100;
//	
//	public Cannon(int Busterlevel, Properties builder) {
//		super(builder);
...
//
//	   public Cannon(Item.Properties propertiesIn) {
//	      super(propertiesIn);
//	   }
//
...
//	         //} else {
//	            projectileentity = createExlosiveFireball(worldIn, shooter, crossbow, projectile);
...
//	   }
//	   
//	   private static FireballEntity createExlosiveFireball(World worldIn, LivingEntity shooter, ItemStack crossbow, ItemStack ammo) {
//		      ArrowItem arrowitem = (ArrowItem)(ammo.getItem() instanceof ArrowItem ? ammo.getItem() : Items.ARROW);
//		      //FireballEntity abstractfireballentity = arrowitem.createArrow(worldIn, ammo, shooter);
////		      if (shooter instanceof PlayerEntity) {
////		    	  abstractfireballentity.setIsCritical(true);
////		      }
//		      Vector3d vector3d = shooter.getLook(1.0F);
//              double d2 = shooter.getPosX();// - (this.parentEntity.getPosX() + vector3d.x * 4.0D);
//              double d3 = shooter.getPosYHeight(0.5D);// - (0.5D + this.parentEntity.getPosYHeight(0.5D));
//              double d4 = shooter.getPosZ();// - (this.parentEntity.getPosZ() + vector3d.z * 4.0D);
//		      FireballEntity abstractfireballentity = new FireballEntity(worldIn, shooter, d2, d3, d4);
////		      abstractfireballentity.setHitSound(SoundEvents.ITEM_CROSSBOW_HIT);
////		      abstractfireballentity.setShotFromCrossbow(true);
////		      int i = EnchantmentHelper.getEnchantmentLevel(Enchantments.PIERCING, crossbow);
////		      if (i > 0) {
////		    	  abstractfireballentity.setPierceLevel((byte)i);
////		      }
//
//		      return abstractfireballentity;
//		   }
//
...
////	                  if (f == 1.0F) {
////	                	  Bustershot.setIsCritical(true);
////	                  }
////
////	                  int j = EnchantmentHelper.getEnchantmentLevel(Enchantments.POWER, stack);
////	                  if (j > 0) {
////	                	  Bustershot.setDamage(Bustershot.getDamage() + (double)j * 0.5D + 0.5D);
////	                  }
////
////	                  int k = EnchantmentHelper.getEnchantmentLevel(Enchantments.PUNCH, stack);
////	                  if (k > 0) {
////	                	  Bustershot.setKnockbackStrength(k);
////	                  }
////
////	                  if (EnchantmentHelper.getEnchantmentLevel(Enchantments.FLAME, stack) > 0) {
////	                	  Bustershot.setFire(100);
////	                  }
////
...
////	                	  Bustershot.pickupStatus = AbstractArrowEntity.PickupStatus.CREATIVE_ONLY;
////	                  }
////
////	                  worldIn.addEntity(Bustershot);
////	               }
////
