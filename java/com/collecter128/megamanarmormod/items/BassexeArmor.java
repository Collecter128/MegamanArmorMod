...
import com.collecter128.megamanarmormod.client.models.bassexe_leggings;
import com.collecter128.megamanarmormod.client.models.bassexe_main;
...
public class BassexeArmor extends ArmorItem{
	...
	public BassexeArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			bassexe_main model = new bassexe_main(1.0f, armorSlot);
        ...
        return (A) model;
			...
			bassexe_leggings model = new bassexe_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/bassexe.png";
    }
