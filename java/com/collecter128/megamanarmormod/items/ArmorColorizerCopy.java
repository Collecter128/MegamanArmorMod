...
public class ArmorColorizerCopy extends Item implements IDyeableArmorItem{

	public int shiftcolor = 0;
	public int shiftpercent = 0;
	
	public ArmorColorizerCopy(Properties properties, int color, int amountbypercent) {
		super(properties);
