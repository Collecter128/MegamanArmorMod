...
import com.collecter128.megamanarmormod.client.models.timeman;
import com.collecter128.megamanarmormod.client.models.timeman_leggings;
...
public class TimemanArmor extends ArmorItem{
	
	public int MainColorDefault = 10514621;//Main Body Color purple
	public int SecondaryColorDefault = 12808110;//Secondary Light Purple
	public int ThirdColorDefault = 16764728; //gold
	public int WhiteColorDefault = 16777215;//White
	public int GlowyColorDefault = 4491492;//Blue
	public int GrayColorDefault = 10592673;//Gray
	public int FourthColorDefault = 16716820; //Red
	...
	public TimemanArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			timeman model = new timeman(1.0f, armorSlot);
	   ...
	   //   else
        ...
        return (A) model;
			...
			timeman_leggings model = new timeman_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/timeman.png";
    }
