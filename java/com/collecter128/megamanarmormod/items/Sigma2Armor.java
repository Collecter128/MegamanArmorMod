...
import com.collecter128.megamanarmormod.client.models.sigma2;
import com.collecter128.megamanarmormod.client.models.sigma2_leggings;
...
public class Sigma2Armor extends ArmorItem{
	
	public int MainColorDefault = 7534849;//Main Body Color Green
	public int SecondaryColorDefault = 964859;//Secondary Blue
	public int ThirdColorDefault = 16507918; //Yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16726559;//Glow? red
	public int GrayColorDefault = 14277081;//gray
	public int FourthColorDefault = 4671303; //Black
	public int FifthColorDefault = 9528480; //Purple
	...
	public Sigma2Armor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		sigma2 model = new sigma2(1.0f, armorSlot);
        ...
        return (A) model;
			...
			sigma2_leggings model = new sigma2_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/sigma2armor.png";
    }
