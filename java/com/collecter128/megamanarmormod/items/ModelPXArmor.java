...
import com.collecter128.megamanarmormod.client.models.modelpx;
import com.collecter128.megamanarmormod.client.models.modelpx_leggings;
...
public class ModelPXArmor extends ArmorItem{
	
	public int MainColorDefault = 14354054;//Main Purple
	public int SecondaryColorDefault = 16641486;//Secondary cream white
	public int ThirdColorDefault = 16761907; //Gold Color
	public int WhiteColorDefault = 16641486;//Cream White
	public int GlowyColorDefault = 16454464;//Glow? red
	public int GrayColorDefault = 13287110;//Gray
	public int FourthColorDefault = 8611706;//Blackish color
	public int FifthColorDefault = 16724835; //Red
	...
	public ModelPXArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		modelpx model = new modelpx(1.0f, armorSlot);
        ...
        return (A) model;
			...
			modelpx_leggings model = new modelpx_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/modelpx.png";
    }
