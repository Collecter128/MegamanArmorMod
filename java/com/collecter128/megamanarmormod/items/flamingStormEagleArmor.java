...
import com.collecter128.megamanarmormod.client.models.flamingstormeagle;
import com.collecter128.megamanarmormod.client.models.flamingstormeagle_leggings;
...
public class flamingStormEagleArmor extends ArmorItem{
	
	public int MainColorDefault = 16582664;//Main red
	public int SecondaryColorDefault = 16777215;//Secondary white
	public int ThirdColorDefault = 16701968; //Yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16582664;//Glow? red
	public int GrayColorDefault = 13421772;//Gray
	public int FourthColorDefault = 4868682; // Black
	public int FifthColorDefault = 16582664; // red
	...
	public flamingStormEagleArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		flamingstormeagle model = new flamingstormeagle(1.0f, armorSlot);
        ...
        return (A) model;
			...
			flamingstormeagle_leggings model = new flamingstormeagle_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/flamingstormeagle.png";
    }
