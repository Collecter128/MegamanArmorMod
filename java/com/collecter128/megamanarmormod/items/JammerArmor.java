...
import com.collecter128.megamanarmormod.client.models.jammer;
import com.collecter128.megamanarmormod.client.models.jammer_leggings;
...
public class JammerArmor extends ArmorItem{
	
	public int MainColorDefault = 9404502;//Main Brown
	public int SecondaryColorDefault = 3880747;//Secondary Black
	public int ThirdColorDefault = 10569285; //Red
	public int WhiteColorDefault = 14999210;//whitish
	public int GlowyColorDefault = 16592939;//Glow? red
	public int GrayColorDefault = 11382189;//gray
	public int FourthColorDefault = 6836535; //??? Not used
	public int FifthColorDefault = 15357837; //pink
	...
	public JammerArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			jammer model = new jammer(1.0f, armorSlot);
        ...
        return (A) model;
			...
			jammer_leggings model = new jammer_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/jammer.png";
    }
