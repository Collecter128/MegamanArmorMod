...
public class SergesArmor extends ArmorItem{
	
	public int MainColorDefault = 1012479;//Main Body Color blue
	public int SecondaryColorDefault = 16715561;//Secondary red
	public int ThirdColorDefault = 16766735; //yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16583976;//Glow? red
	public int GrayColorDefault = 16777215;//Basic White
	public int FourthColorDefault = 4871268; //Dark Gray
	public int FifthColorDefault = 3066929; //glow green
	...
	public SergesArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		serges model = new serges(1.0f, armorSlot);
        ...
        return (A) model;
			...
			serges_leggings model = new serges_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/serges.png";
    }
