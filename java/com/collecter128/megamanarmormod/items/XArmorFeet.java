...
import com.collecter128.megamanarmormod.client.models.xarmor_feet;
import com.collecter128.megamanarmormod.client.models.xarmor_feetcolor;
...
public class XArmorFeet extends ArmorItem{
	...
	public XArmorFeet(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		xarmor_feetcolor model = new xarmor_feetcolor(1.0f);
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/xarmor_layer_1.png";
    }
