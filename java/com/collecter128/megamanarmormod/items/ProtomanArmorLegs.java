...
import com.collecter128.megamanarmormod.client.models.protomanarmor_leggingscolor;
...
public class ProtomanArmorLegs extends ArmorItem{
	...
	public ProtomanArmorLegs(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		protomanarmor_leggingscolor model = new protomanarmor_leggingscolor(1.0f);
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/protomanarmor2.png";
    }
