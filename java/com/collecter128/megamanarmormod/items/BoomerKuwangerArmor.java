...
import com.collecter128.megamanarmormod.client.models.boomerkuwanger;
import com.collecter128.megamanarmormod.client.models.boomerkuwanger_leggings;
...
public class BoomerKuwangerArmor extends ArmorItem{
	
	public int MainColorDefault = 16725033;//Main Body Color Red
	public int SecondaryColorDefault = 2706943;//Secondary Blue
	public int ThirdColorDefault = 16767529; //Yellow parts
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 8247606;//Glow? Green
	public int GrayColorDefault = 12237498;//gray
	public int FourthColorDefault = 3096145; //Black
	public int FifthColorDefault = 2729727; //Light Blue
	...
	public BoomerKuwangerArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			boomerkuwanger model = new boomerkuwanger(1.0f, armorSlot);
        ...
        return (A) model;
			...
			boomerkuwanger_leggings model = new boomerkuwanger_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/boomerkuwanger.png";
    }
