...
import com.collecter128.megamanarmormod.client.models.zeroexarmor;
...
public class ZeroEXArmor extends ArmorItem{
	...
	public ZeroEXArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		zeroexarmor model = new zeroexarmor(1.0f, armorSlot);
