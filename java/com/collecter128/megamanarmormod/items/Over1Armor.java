...
import com.collecter128.megamanarmormod.client.models.over1;
import com.collecter128.megamanarmormod.client.models.over1_leggings;
...
public class Over1Armor extends ArmorItem{
	...
	public Over1Armor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			over1 model = new over1(1.0f, armorSlot);
        ...
        return (A) model;
			...
			over1_leggings model = new over1_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/over1.png";
    }
