...
import com.collecter128.megamanarmormod.client.models.superbassevil;
import com.collecter128.megamanarmormod.client.models.superbassevil_legs;
...
public class SuperBassEvilArmor extends ArmorItem{
	
	public int MainColorDefault = 5855577;//Main Body Color black
	public int SecondaryColorDefault = 11350269;//Secondary purple
	public int ThirdColorDefault = 11350269;//purple
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 1011711;//Glow? blue
	public int GrayColorDefault = 13750737;//
	public int FourthColorDefault = 13750737; // 
	...
	public SuperBassEvilArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			superbassevil model = new superbassevil(1.0f, armorSlot);
...
//	    	  itemStack.getOrCreateTagElement("displaymm").putInt("FourthColor", FourthColorDefault);
        ...
        return (A) model;
			...
			superbassevil_legs model = new superbassevil_legs(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/superbassevil.png";
    }
