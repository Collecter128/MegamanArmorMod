...
import com.collecter128.megamanarmormod.client.models.megaarmorbase;
...
public class megaarmorbaseArmor extends ArmorItem{
	...
	public int GlowyColorDefault = 2752287;//Glow?green core thingy
	...
	public megaarmorbaseArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			megaarmorbase model = new megaarmorbase(1.0f, armorSlot);
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/megaarmor_base.png";
    }
