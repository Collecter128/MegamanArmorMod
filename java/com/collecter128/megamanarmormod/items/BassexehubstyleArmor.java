...
import com.collecter128.megamanarmormod.client.models.bassexehubstyle_leggings;
import com.collecter128.megamanarmormod.client.models.bassexehubstyle_main;
...
public class BassexehubstyleArmor extends ArmorItem{
	
	public int MainColorDefault = 4604492;//Main Body Color Black
	public int SecondaryColorDefault = 16694555;//Secondary Yellow
	public int ThirdColorDefault = 16694555; //gold/yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 6651843;//Glow? blue
	public int GrayColorDefault = 11053224;//gray
	public int FourthColorDefault = 10250937; // purple (Hubstyle bass green 65428) 
	public int FifthColorDefault = 6651843; //Blue
	...
	public BassexehubstyleArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			bassexehubstyle_main model = new bassexehubstyle_main(1.0f, armorSlot);
        ...
        return (A) model;
			...
			bassexehubstyle_leggings model = new bassexehubstyle_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/bassexehubstyle.png";
    }
