...
public class Busterx extends ShootableItem{ // implements IVanishable

	static int BusterPowerLevel = 4;
	static int chargeLevel = 0;
	
	//base damaged is 2.0f
	
	public Busterx(int Busterlevel, Properties builder) {
		super(builder);
...
//	   }
	   ...
	   public void releaseUsing(ItemStack p_77615_1_, World p_77615_2_, LivingEntity p_77615_3_, int p_77615_4_) {
	      if (p_77615_3_ instanceof PlayerEntity) {
	         ...
	         if (!itemstack.isEmpty() || flag) {
	            ...
	            if (!((double)f < 0.1D)) { // Charged enough to fire a shot
	               ...
	               if (!p_77615_2_.isClientSide) {
	                  ...
	                  if (f >= 1.0F) {
	                     ...
	                     abstractarrowentity.setBaseDamage(2.0f);
	                  }
	                  if (f >= 2.0F) {
		                 abstractarrowentity.setBaseDamage(3.0f);
		              }
	                  if (f >= 3.0F) {
		                  abstractarrowentity.setBaseDamage(4.0f);
		              }
	            ...
	            }// Charged enough to fire a shot end
	         }
	      }
	   }
	   ...
	   public bustershotentity createBlast(World world, ItemStack stack, LivingEntity entity) {
		      //ArrowEntity arrowentity = new ArrowEntity(world, entity);
		      bustershotentity shotentity = new bustershotentity(world, entity);
