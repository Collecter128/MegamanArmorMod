...
import com.collecter128.megamanarmormod.client.models.copyx;
import com.collecter128.megamanarmormod.client.models.copyx_leggings;
...
public class CopyXArmor extends ArmorItem{
	
	public int MainColorDefault = 6512125;//Main Body Blue
	public int SecondaryColorDefault = 6082303;//Secondary Light Blue
	public int ThirdColorDefault = 16731202; //Red
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16606557;//Glow? red
	public int GrayColorDefault = 7371678;//dark gray
	public int FourthColorDefault = 7371678; //dark gray
	...
	public CopyXArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			copyx model = new copyx(1.0f, armorSlot);
...
//	    	  itemStack.getOrCreateTagElement("displaymm").putInt("FourthColor", FourthColorDefault);
        ...
        return (A) model;
			...
			copyx_leggings model = new copyx_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/copyx.png";
    }
