...
import com.collecter128.megamanarmormod.client.models.phantom;
import com.collecter128.megamanarmormod.client.models.phantom_leggings;
...
public class PhantomArmor extends ArmorItem{
	...
	public int MainColorDefault = 7428758;//Main Grayish Purple
	public int SecondaryColorDefault = 16453210;//Secondary Red
	public int ThirdColorDefault = 15578448; //gold
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16653125;//Glow? red
	public int GrayColorDefault = 12625359;//gray
	public int FourthColorDefault = 16777215; //White
	public int FifthColorDefault = 16653125; //Red
	...
	public PhantomArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			phantom model = new phantom(1.0f, armorSlot);
        ...
        return (A) model;
			...
			phantom_leggings model = new phantom_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/phantom.png";
    }
