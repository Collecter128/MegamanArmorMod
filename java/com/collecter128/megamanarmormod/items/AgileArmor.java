...
import com.collecter128.megamanarmormod.client.models.agile;
import com.collecter128.megamanarmormod.client.models.agile_leggings;
...
public class AgileArmor extends ArmorItem{
	
	public int MainColorDefault = 12348640;//Main Body Color Purple
	public int SecondaryColorDefault = 58998;//Secondary Green
	public int ThirdColorDefault = 15129344; //Yellow
	public int WhiteColorDefault = 16642786;//Basic White
	public int GlowyColorDefault = 16715013;//Glow? red
	public int GrayColorDefault = 15722706;//Gray
	public int FourthColorDefault = 5066592; //Black
	public int FifthColorDefault = 16679362; //Pink
	...
	public AgileArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		agile model = new agile(1.0f, armorSlot);
        ...
        return (A) model;
			...
			agile_leggings model = new agile_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/agile.png";
    }
