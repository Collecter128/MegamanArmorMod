...
import com.collecter128.megamanarmormod.client.models.starforceMegaman;
import com.collecter128.megamanarmormod.client.models.starforceMegaman_legs;
import com.collecter128.megamanarmormod.client.models.xke;
import com.collecter128.megamanarmormod.client.models.xke_legs;
import com.collecter128.megamanarmormod.client.models.xkeboost;
import com.collecter128.megamanarmormod.client.models.xkeboost_legs;
...
public class StarforceArmor extends ArmorItem{
	
	public int MainColorDefault = 708351;//Main Body Color light blue
	public int SecondaryColorDefault = 4013982;//Secondary dark blue
	public int ThirdColorDefault = 16771133; //gold
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			starforceMegaman model = new starforceMegaman(1.0f, armorSlot);
        ...
        return (A) model;
			...
			starforceMegaman_legs model = new starforceMegaman_legs(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/megamanstarforce.png";
    }
