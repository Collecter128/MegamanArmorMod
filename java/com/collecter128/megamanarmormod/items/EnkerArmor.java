...
import com.collecter128.megamanarmormod.client.models.enker;
import com.collecter128.megamanarmormod.client.models.enker_leggings;
...
public class EnkerArmor extends ArmorItem{
	
	public int MainColorDefault = 16766991;//Main gold
	public int SecondaryColorDefault = 6906571;//Secondary blue
	public int ThirdColorDefault = 16615688; //Orange parts
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16711680;//Glow? red
	public int GrayColorDefault = 8882055;//gray
	public int FourthColorDefault = 8882055; //gray
	public int FifthColorDefault = 16711680; //red
	...
	public EnkerArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		enker model = new enker(1.0f, armorSlot);
        ...
        return (A) model;
			...
			enker_leggings model = new enker_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/enker.png";
    }
