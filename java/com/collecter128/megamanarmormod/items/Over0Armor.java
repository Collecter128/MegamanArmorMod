...
import com.collecter128.megamanarmormod.client.models.over0;
import com.collecter128.megamanarmormod.client.models.over0_leggings;
...
public class Over0Armor extends ArmorItem{
	
	public int MainColorDefault = 4022712;//Main Dark Blue
	public int SecondaryColorDefault = 4542568;//Secondary Black
	public int ThirdColorDefault = 8039403; //Light Blue
	public int WhiteColorDefault = 16777215;//White
	public int GlowyColorDefault = 14170939;//red
	public int GrayColorDefault = 10724259;//gray
	public int FourthColorDefault = 16765235;//gold
	...
	public Over0Armor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			over0 model = new over0(1.0f, armorSlot);
        ...
        return (A) model;
			...
			over0_leggings model = new over0_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/over0.png";
    }
