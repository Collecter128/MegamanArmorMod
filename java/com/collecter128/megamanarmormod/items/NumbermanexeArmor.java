...
import com.collecter128.megamanarmormod.client.models.numbermanexe;
import com.collecter128.megamanarmormod.client.models.numbermanexe_leggings;
...
public class NumbermanexeArmor extends ArmorItem{
	
	public int MainColorDefault = 10091319;//Main Green
	public int SecondaryColorDefault = 14532503;//Secondary Cream
	public int ThirdColorDefault = 16600343; //Orange parts
	public int WhiteColorDefault = 12305609;//Slightly Blue, mostly white
	public int GlowyColorDefault = 16635947;//Glow? Yellow
	public int GrayColorDefault = 11579568;//gray
	public int FourthColorDefault = 6710886; //Black
	public int FifthColorDefault = 16635947; //yellow
	...
	public NumbermanexeArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			numbermanexe model = new numbermanexe(1.0f, armorSlot);
        ...
        return (A) model;
			...
			numbermanexe_leggings model = new numbermanexe_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/numbermanexe.png";
    }
