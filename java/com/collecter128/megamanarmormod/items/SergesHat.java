...
public class SergesHat extends ArmorItem{
	...
	public SergesHat(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		serges_hat model = new serges_hat(1.0f);
