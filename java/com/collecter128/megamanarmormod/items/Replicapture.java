...
import com.collecter128.megamanarmormod.client.models.replicapture;
...
public class Replicapture extends ArmorItem{
	...
	public Replicapture(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		replicapture model = new replicapture(1.0f);
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/replicapture.png";
    }
