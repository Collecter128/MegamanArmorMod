...
import com.collecter128.megamanarmormod.client.models.servbot;
import com.collecter128.megamanarmormod.client.models.servbot_leggings;
...
public class ServbotArmor extends ArmorItem{
	
	public int MainColorDefault = 2913020;//Main Body Color Dark Blue
	public int SecondaryColorDefault = 9431294;//Secondary LightBlue
	public int ThirdColorDefault = 16771123; //Yellow parts
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16726579;//Glow? red not used
	public int GrayColorDefault = 9737364;//Gray
	public int FourthColorDefault = 9737364; //Not Used Gray 
	public int FifthColorDefault = 16729897; //Red
	...
	public ServbotArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			servbot model = new servbot(1.0f, armorSlot);
        ...
        return (A) model;
			...
			servbot_leggings model = new servbot_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/servbot.png";
    }
