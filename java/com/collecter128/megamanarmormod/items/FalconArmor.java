...
import com.collecter128.megamanarmormod.client.models.falconarmor;
import com.collecter128.megamanarmormod.client.models.falconarmor_leggings;
...
public class FalconArmor extends ArmorItem{
	...
	public int FourthColorDefault = 9614024; //??? (Chest thingy for other armors?
	...
	public FalconArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			falconarmor model = new falconarmor(1.0f, armorSlot);
        ...
        return (A) model;
			...
			falconarmor_leggings model = new falconarmor_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/falconarmor.png";
    }
