...
public class NovaZeroArmor extends ArmorItem{
	...
	public int ThirdColorDefault =  16763151; //yellow
	...
	public NovaZeroArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			novazero_main model = new novazero_main(1.0f, armorSlot);
        ...
        return (A) model;
			...
			novazero_leggings model = new novazero_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/nova_zeroarmor.png";
    }
