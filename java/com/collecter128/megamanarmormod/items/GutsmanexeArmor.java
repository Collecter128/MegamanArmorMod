...
public class GutsmanexeArmor extends ArmorItem{
	
	public int MainColorDefault = 16637468;//Main Body Color Yellow
	public int SecondaryColorDefault = 16590620;//Secondary Red
	public int ThirdColorDefault = 5395026; //Black
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 4296775;//Glow? green
	public int GrayColorDefault = 12895428;//Gray
	public int FourthColorDefault = 4296775; //Green
	...
	public GutsmanexeArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			gutsmanexe model = new gutsmanexe(1.0f, armorSlot);
...
//	    	  itemStack.getOrCreateTagElement("displaymm").putInt("FourthColor", FourthColorDefault);
        ...
        return (A) model;
			...
			gutsmanexe_legs model = new gutsmanexe_legs(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/gutsmanexe.png";
    }
