...
import com.collecter128.megamanarmormod.client.models.ciel;
...
public class CielArmor extends ArmorItem{
	
	public int MainColorDefault = 16727445;//Main Pink
	public int SecondaryColorDefault = 16056442;//Secondary Dark Pink
	public int ThirdColorDefault = 16759306; //Hair Yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16754899;//Glow Pink (Not used)
	public int GrayColorDefault = 12423076;//Not used
	public int FourthColorDefault = 7687541; // Black
	...
	public CielArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		//if(armorSlot != ) {
			ciel model = new ciel(1.0f, armorSlot);
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/ciel.png";
    }
