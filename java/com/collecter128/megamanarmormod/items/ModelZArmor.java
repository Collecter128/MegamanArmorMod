...
import com.collecter128.megamanarmormod.client.models.modelz;
import com.collecter128.megamanarmormod.client.models.modelz_leggings;
...
public class ModelZArmor extends ArmorItem{
	
	public int MainColorDefault = 16722241;//Main Body red
	...
	public int GlowyColorDefault = 250751;// green
	...
	public ModelZArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			modelz model = new modelz(1.0f, armorSlot);
...
//	    	  itemStack.getOrCreateTagElement("displaymm").putInt("FourthColor", FourthColorDefault);
        ...
        return (A) model;
			...
			modelz_leggings model = new modelz_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/modelz.png";
    }
