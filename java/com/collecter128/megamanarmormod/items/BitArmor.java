...
import com.collecter128.megamanarmormod.client.models.bit;
import com.collecter128.megamanarmormod.client.models.bit_leggings;
...
public class BitArmor extends ArmorItem{
	
	public int MainColorDefault = 16634376;//Main gold
	public int SecondaryColorDefault = 16615944;//Secondary orange
	public int ThirdColorDefault = 14682880; //red
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16714250;//Glow? red
	public int GrayColorDefault = 12434877;//gray
	public int FourthColorDefault = 3376639; //blue
	public int FifthColorDefault = 6411749; //light blue
	...
	public BitArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			bit model = new bit(1.0f, armorSlot);
        ...
        return (A) model;
			...
			bit_leggings model = new bit_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/bit.png";
    }
