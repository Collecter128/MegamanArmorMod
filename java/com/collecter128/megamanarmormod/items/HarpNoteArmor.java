...
import com.collecter128.megamanarmormod.client.models.harpnote;
...
public class HarpNoteArmor extends ArmorItem{
	
	public int MainColorDefault = 16737926;//Main Body Color Dark Pink
	public int SecondaryColorDefault = 16751006;//Secondary Pink
	public int ThirdColorDefault = 16768845; //Yellow
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 391167;//Glow Light Blue
	public int GrayColorDefault = 13686748;// Grey
	public int FourthColorDefault = 7161450; // Black
	...
	public HarpNoteArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	//	if(armorSlot != EquipmentSlotType.LEGS) {
			harpnote model = new harpnote(1.0f, armorSlot);
...
//	    	  itemStack.getOrCreateTagElement("displaymm").putInt("FourthColor", FourthColorDefault);
	...
	//	}
//		else {
//			hubstyle_leggings model = new hubstyle_leggings(1.0f);
//			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
//
//			model.young = _default.young;
//	        model.crouching = _default.crouching;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/harpnote.png";
    }
