...
import com.collecter128.megamanarmormod.client.models.zerofc;
import com.collecter128.megamanarmormod.client.models.zerofc_legs;
...
public class ZeroFCArmor extends ArmorItem{
	
	public int MainColorDefault = 16659586;//Main Body Color Magenta
	public int SecondaryColorDefault = 16777215;//Secondary White
	public int ThirdColorDefault = 0; //Black
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 16761671;//Glow? Orange
	public int GrayColorDefault = 10066329;//Gray
	public int FourthColorDefault = 16777215; //White
	public int FifthColorDefault = 8773093; //Light Blue
	...
	public ZeroFCArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			zerofc model = new zerofc(1.0f, armorSlot);
...
//	    	  itemStack.getOrCreateTagElement("displaymm").putInt("FourthColor", FourthColorDefault);
        ...
        return (A) model;
			...
			zerofc_legs model = new zerofc_legs(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/zeroarmorfc.png";
    }
