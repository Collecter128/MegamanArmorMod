...
import com.collecter128.megamanarmormod.client.models.gaeaarmor_leggings;
import com.collecter128.megamanarmormod.client.models.gaeaarmor_main;
...
public class GaeaArmor extends ArmorItem{
	
	public int MainColorDefault = 2781423;//Main Body Color X Blue
	public int SecondaryColorDefault = 5752303;//Secondary Cyan tiel color
	...
	public int GrayColorDefault = 9079434;//Gray
	public int FourthColorDefault = 11520735; //BlueGray
	...
	public GaeaArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		gaeaarmor_main model = new gaeaarmor_main(1.0f, armorSlot);
        ...
        return (A) model;
			...
			gaeaarmor_leggings model = new gaeaarmor_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/gaeaarmor.png";
    }
