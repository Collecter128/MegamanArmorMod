...
import com.collecter128.megamanarmormod.client.models.halloweenvile;
import com.collecter128.megamanarmormod.client.models.halloweenvile_leggings;
...
public class HalloweenVileArmor extends ArmorItem{
	
	public int MainColorDefault = 15617071;//Main red
	public int SecondaryColorDefault = 5526612;//Secondary lighter black
	public int ThirdColorDefault = 15831049; //Orange parts
	public int WhiteColorDefault = 16777215;//Basic White
	public int GlowyColorDefault = 15617071;//Glow? red
	public int GrayColorDefault = 13750737;//Gray
	public int FourthColorDefault = 0; //Darker Black
	public int FifthColorDefault = 6863908; //green
	...
	public HalloweenVileArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		...
		if(armorSlot != EquipmentSlotType.LEGS) {
			halloweenvile model = new halloweenvile(1.0f, armorSlot);
        ...
        return (A) model;
			...
			halloweenvile_leggings model = new halloweenvile_leggings(1.0f);
			model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
...
//	@Nullable
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
        return "megamanarmormod:textures/armor/halloween_vile.png";
    }
