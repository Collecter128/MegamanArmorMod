...
public class IcemanArmor extends ArmorItem{
	...
	public int MainColorDefault = 6058751;//Blue
	public int SecondaryColorDefault = 16777215;//white
	public int WhiteColorDefault = 16777215;//white
	public int ThirdColorDefault = 6058751; //blue
	public int GlowyColorDefault = 16658443;//red
	public int GrayColorDefault = 4931443;//gray
	public int FourthColorDefault = 4931443;//gray
	...
	public IcemanArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	if(armorSlot == EquipmentSlotType.HEAD) {
		iceman model = new iceman(1.0f, armorSlot);
		...
		iceman_legs model = new iceman_legs(1.0f);
		model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
