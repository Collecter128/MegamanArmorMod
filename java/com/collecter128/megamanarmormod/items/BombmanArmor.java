...
public class BombmanArmor extends ArmorItem{
	...
	public int MainColorDefault = 16439823;//yellow
	public int SecondaryColorDefault = 16479267;//orange
	public int WhiteColorDefault = 15921906;//Basic White
	public int ThirdColorDefault = 4671303; //Black
	public int GlowyColorDefault = 437505;//Green
	public int GrayColorDefault = 15592941;//gray
	public int FourthColorDefault = 15592941;//gray
	...
	public BombmanArmor(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
	...
	if(armorSlot == EquipmentSlotType.HEAD) {
		bombman model = new bombman(1.0f, armorSlot);
		...
		bombman_legs model = new bombman_legs(1.0f);
		model.hat.visible = armorSlot == EquipmentSlotType.HEAD;
